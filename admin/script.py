...
# Create complete admin panel files for Smart Crop Advisory System
...
$host = 'localhost';
$dbname = 'smartcrop'; // Change to your database name
...
with open('admin_panel/db_connect.php', 'w', encoding='utf-8') as f:
    f.write(db_connect)
    
with open('admin_panel/login.php', 'w', encoding='utf-8') as f:
    f.write(login_php)

print("Created: db_connect.php, login.php")
